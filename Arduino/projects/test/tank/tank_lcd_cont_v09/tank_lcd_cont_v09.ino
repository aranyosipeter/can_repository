...
/********            Avoid prell       ***********/
boolean             leftButtonAcc          = false;
boolean             leftButtonDec          = false;
boolean             rightButtonAcc         = false;
boolean             rightButtonDec         = false;
...
void digController(){
  if ( menuEnable == false ) {
    ...
    if ( prevLCount != leftCount ){
      lcd.setCursor(0,0);
      lcd.print(acceLeft);
      prevLCount = leftCount;
    }
    if ( prevRCount != rightCount ){
      lcd.setCursor(11,0);
      lcd.print(acceRight);

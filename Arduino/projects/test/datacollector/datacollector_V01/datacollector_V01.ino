...
IPAddress server_addr(192,168,0,100);  // Supply the IP of the MySQL *server* here

char user[] = "aranyosi";         // can be anything but the user must have
char password[] = "aranyosi1991";   // access rights to connect (host must permit it)
...
void loop() {
  if (( millis() % 100 ) == 0 ){
    ...
    sprintf(query, INSERT_DATA, id, name, temperature);

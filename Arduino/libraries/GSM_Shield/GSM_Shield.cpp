...
void  GSMLib::BlinkDebugLED (byte num_of_blink)
  {
    byte i;
...
**********************************************************/
void GSMLib::DebugPrint(const char *string_to_print, byte last_debug_print)
{
  if (last_debug_print) {
...
void GSMLib::DebugPrint(int number_to_print, byte last_debug_print)
{
...
**********************************************************/
void GSMLib::RxInit(uint16_t start_comm_tmout, uint16_t max_interchar_tmout)
{
...
**********************************************************/
byte GSMLib::IsStringReceived(char const *compare_string)
{
  char *ch;
  byte ret_val = 0;
...
**********************************************************/
byte GSMLib::WaitResp(uint16_t start_comm_tmout, uint16_t max_interchar_tmout)
{
  byte status;
...
**********************************************************/
char GSMLib::SendATCmdWaitResp(char const *AT_cmd_string,
...
**********************************************************/
void GSMLib::TurnOn(long baud_rate)
{
...
**********************************************************/
void GSMLib::InitParam(byte group)
{
...
off_on: 0 - off
        1 - on
**********************************************************/
void GSMLib::SetSpeaker(byte off_on)
{
  if (CLS_FREE != GetCommLineStatus()) return;
  SetCommLineStatus(CLS_ATCMD);
  if (off_on) {
...
return values: 
      ...
      REG_COMM_LINE_BUSY  - comm line between GSM module and Arduino is not free
                            for communication
**********************************************************/
byte GSMLib::CheckRegistration(void)
{
  byte status;
...
return: 
      ...
      CALL_COMM_LINE_BUSY         - comm line is not free
**********************************************************/
byte GSMLib::CallStatusWithAuth(char *phone_number,
...
**********************************************************/
void GSMLib::Call(char *number_string)
{
  if (CLS_FREE != GetCommLineStatus()) return;
  SetCommLineStatus(CLS_ATCMD);
  // ATDxxxxxx;<CR>
...
sim_position: position in the SIM <1...>
              e.g. gsm.Call(1);
**********************************************************/
void GSMLib::Call(int sim_position)
{
  if (CLS_FREE != GetCommLineStatus()) return;
  SetCommLineStatus(CLS_ATCMD);
  // ATD>"SM" 1;<CR>
...
**********************************************************/
char GSMLib::SetSpeakerVolume(byte speaker_volume)
{
...
return: 
        ...
        0..14 current speaker volume 
**********************************************************/
char GSMLib::IncSpeakerVolume(void)
{
  char ret_val;
...
return: 
        ...
        0..14 current speaker volume 
**********************************************************/
char GSMLib::DecSpeakerVolume(void)
{
  char ret_val;
  byte current_speaker_value;
...
return: 
        ...
        0.. tone
**********************************************************/
char GSMLib::SendDTMFSignal(byte dtmf_tone)
{
  char ret_val = -1;
...
return: 0 - not pushed = released
        1 - pushed
**********************************************************/
byte GSMLib::IsUserButtonPushed(void)
{
  byte ret_val = 0;
...
**********************************************************/
char GSMLib::SendSMS(char *number_str, char *message_str) 
{
  char ret_val = -1;
  byte i;
...
**********************************************************/
char GSMLib::SendSMS(byte sim_phonebook_position, char *message_str) 
{
  char ret_val = -1;
...
**********************************************************/
char GSMLib::InitSMSMemory(void) 
{
  char ret_val = -1;
...
**********************************************************/
char GSMLib::IsSMSPresent(byte required_status) 
{
  char ret_val = -1;
  char *p_char;
  byte status;
...
**********************************************************/
char GSMLib::GetSMS(byte position, char *phone_number, char *SMS_text, byte max_SMS_len) 
{
  char ret_val = -1;
  char *p_char; 
  char *p_char1;
...
**********************************************************/
char GSMLib::GetAuthorizedSMS(byte position, char *phone_number, char *SMS_text, byte max_SMS_len,
                           byte first_authorized_pos, byte last_authorized_pos)
{
  char ret_val = -1;
  byte i;
...
return: 
        ...
        1 - SMS was deleted
**********************************************************/
char GSMLib::DeleteSMS(byte position) 
{
  char ret_val = -1;
...
**********************************************************/
char GSMLib::GetPhoneNumber(byte position, char *phone_number)
{
  char ret_val = -1;
...
**********************************************************/
char GSMLib::WritePhoneNumber(byte position, char *phone_number)
{
  char ret_val = -1;
...
**********************************************************/
char GSMLib::DelPhoneNumber(byte position)
{
  char ret_val = -1;
...
**********************************************************/
char GSMLib::ComparePhoneNumber(byte position, char *phone_number)
{
  char ret_val = -1;
  char sim_phone_number[20];
